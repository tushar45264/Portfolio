...
const projects = () => {
  ...
  return (
    ...
    >
      <div className="h-[6px] w-[64px] bg-blue-500  pt-2 mt-24 rounded-md" data-aos="fade-right" data-aos-duration="100"></div>
        ...
        {project.map((item)=>( 
          <div className='text-main flex flex-col md:flex-row mt-20  mb-20 md:mb-40'>
              ...
              <div className='flex flex-col' data-aos="fade-right" data-aos-delay="400">
                <div className='font-Space text-blue-500 text-sm mt-16 md:mt-8 lg:mt-24'>Project {item.id}</div>
                ...
                <div className='flex flex-row font-Space text-blue-500 text-xs md:text-sm justify-end mr-2'>{item.tech.map((i)=>(
                  <div className='mr-6 mt-4'>{i}</div>
                ))}</div>
                <div className='text-2xl mt-4 flex justify-end mr-8'>
                <div className='text-blue-500 opacity-90'><BsArrowRightShort/></div>
