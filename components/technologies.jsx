...
const technologies = () => {
  return (
    ...
    <div className="h-[6px] w-[64px] bg-blue-500  pt-2 mt-44 rounded-md " data-aos="fade-up" data-aos-duration="100"></div>
      ...
      <div data-aos="fade-up" data-aos-delay="600" className="flex flex-col md:flex-row">
        {tech.map((item) => (
          ...
          <div className="text-main text-5xl mb-4">
            ...
            <div className="text-blue-600 font-semibold opacity-[.95] text-xl md:text-3xl">{item.title}</div>
